        ...
        <div id='a4' className={`bg-white text-black `} style={{
            ...
            <div className={`flex flex-col h-full ${getPageMarginClass()}`}>
                ...
                {formData.summerTraining.length > 0 &&
                    <div className={`mt-4 flex flex-col ${getLineHeightClass()} ${formData.visibility.summerTraining ? '' : 'hidden'} `}>
                        ...
                        {formData.summerTraining.map((training, index) => (
                            <div key={index} className={` flex flex-col ${getLineHeightClass()} ${getFontSizeClass()} `}>
                        ...
                        {formData.internships.map((internship, index) => (
                            <div key={index} className={` flex flex-col ${getLineHeightClass()} ${getFontSizeClass()}`} >
                                <div className={`flex justify-between gap-4`}>
                                    <p className={` font-semibold ${getHeadingFontSizeClass()}`}>{internship.company}</p>
                                ...
                                <Markdown className={`ml-4 break-normal`}>{internship.experience}</Markdown>
                            </div>
                        ))}
                    </div>
                }
                ...
                {formData.projects.length > 0 &&
                    <div className={`mt-4 flex flex-col ${getLineHeightClass()} ${formData.visibility.projects ? '' : 'hidden'}`}>
                ...
                {formData.achievements.length > 0 &&
                    <div className={`mt-4 flex flex-col ${getLineHeightClass()}  ${formData.visibility.achievements ? '' : 'hidden'}`}>
                ...
                {formData.certifications.length > 0 &&
                    <div className={`mt-4 flex flex-col ${getLineHeightClass()}  ${formData.visibility.certifications ? '' : 'hidden'}`}>
                ...
                {formData.technicalSkills.length > 0 &&
                    <div className={`mt-4 flex flex-col ${getLineHeightClass()} `}>
                        <p className={`font-bold ${getTitleCaseClass()} ${getHeadingFontSizeClass()} ${getLineHeightClass()}`}>Skills</p>
                        <div className={`divider h-[1px] w-full bg-black mt-0 mb-2`} />
                        <div className={`flex flex-col gap-1 ${getLineHeightClass()}  ${getFontSizeClass()}`}>

...
const ReferAndEarn = ({ referalDetails }) => {
  ...
  const sortedReferredUsers = referredUsers.sort(
      ...
      <div className="text-gray-900 dark:text-gray-200">
        <div className="flex justify-between items-center">
          <h1 className="lg:text-6xl sm:text-4xl text-2xl font-semibold">
            Refer a friend and earn <span className="lg:text-7xl sm:text-5xl text-3xl">5</span> credits
          </h1>
      ...
      <div className="flex flex-col gap-4 text-gray-900 dark:text-gray-200">
        ...
        <div className="flex flex-col gap-4 max-h-96 overflow-y-auto pr-4 p-6 pt-0">
          {referredUsers.length === 0 ? (
            ...
            sortedReferredUsers.map((user, index) => (
              <div
                key={index}
